...
- Configure network devices to send syslog to the host running the **ktranslate** docker container. Here's how to configure network syslog data collection in some devices:
